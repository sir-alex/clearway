...
export const UiIcon: React.FC<Props> = React.memo(({type, className}) => {
    ...
    const addIcon = () => {
        return (
            <svg className={className} version="1.2" baseProfile="tiny-ps" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30" height="30">
                <defs>
                    <image  width="28" height="28" id="img2" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABwAAAAcBAMAAACAI8KnAAAAAXNSR0IB2cksfwAAABJQTFRFAAAA////////////////////PlKtOgAAAAZ0Uk5TAP9VZo4p8/mltgAAAChJREFUeJxjYAADQSEGZDDIuYLIQJgAVwkMBEXAlOpg8QIxXGNTCA0AYKMIHpKY1egAAAAASUVORK5CYII="/>
                </defs>
                <use id="Layer 3 copy" href="#img2" x="1" y="1" />
            </svg>
        )
    }
    switch (type) {
